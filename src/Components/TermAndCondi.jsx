...
const TermAndCondi = () => {
  return (
    <>
      <div className="terms_and_Contidition">
        <div className="terms_and_Contidition_1">
        <h1>Terms and Condition</h1>
        </div>
      <div className="terms_and_Contidition_2">
      <p>Home  <span> &gt;&gt;Terms and Conditions</span> </p>
      </div>
       
      </div>

      <div className="terms_and_Contidition_3">
        <div className="terms_and_Contidition_top">
        <h1>OVERVIEW</h1>
        <p>
        This website is operated by<span> Triangle Space Private Limited. </span>Throughout the site, the terms “we”, “us” and “our” refer to Triangle Space Private Limited. Triangle Space Private Limited offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
        </p>
...
<div className="terms_and_Contidition_bottom">
  <div className="terms_and_Contidition_section">
...
<div  className="terms_and_Contidition_section">
        ...
        <p> Certain content, products and services available via our Service may
...
<div  className="terms_and_Contidition_section">
       ...
       <a href="mailto:info@trianglespace.in"
                      target="_blank"><span> info@trianglespace.in.</span></a>
        </p>
        </div>
