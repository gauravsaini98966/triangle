    ...
    <>
      <div className='about'>
        <div className="upr">
          ...
          <div ><h2 className='texth2'> <FaCheck />{Aboutdata[0].text4a}</h2></div>
          <div><h2 className='texth2'> <FaCheck />{Aboutdata[0].text4b} </h2></div>
          <div><h2 className='texth2'> <FaCheck />{Aboutdata[0].text4c} </h2></div>
          <div><h2 className='texth2'> <FaCheck />{Aboutdata[0].text4d} </h2></div>
          <div><h2 className='texth2'> <FaCheck />{Aboutdata[0].text4e} </h2></div>
          <div><h2 className='texth2'> <FaCheck />{Aboutdata[0].text4f} </h2></div>
          <div><h2 className='texth2'> <FaCheck />{Aboutdata[0].text4g} </h2></div>
        </div>
        <div>
